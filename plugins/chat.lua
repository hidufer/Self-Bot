...
if matches[1] == "بای" then
     ...
     if msg.to.type == 'channel' or 'chat' then
            local answers = {'اصل چیه؟','برای چیته آخه','به من رحم کن 😖','پووووووف اصل برای چیته','هوووووم','چی بگم','اصررا نکن اصل نمیدم','نمیدم'}
            return answers[math.random(#answers)]
      end
	  end
      ...
      if msg.to.type == 'channel' or 'chat' then
            local answers = {'چی اره؟','مسخره کردیاا','مگه من با تو شوخی دارم','من امین م چی میخوای از دستم','ولم کن مستر ','نمیدم اصلا','ندارم جون تو','نمییییدیییمم','ول کن برو ندارم'}
            return answers[math.random(#answers)]
      end
	   end
