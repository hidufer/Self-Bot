function run(msg, matches)
		...
		local url = "http://www.keepcalmstudio.com/-/p.php?t=%EE%BB%AC%0D%0AKEEP%0D%0ACALM%0D%0A"..text1.."%0D%0A"..text2.."%0D%0A"..text3.."&bc=00E5FF&tc=000000&cc=000000&uc=true&ts=true&ff=PNG&w=500&ps=sq"
