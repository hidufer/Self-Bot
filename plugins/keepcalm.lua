...
local url = "http://www.keepcalmstudio.com/-/p.php?t=%EE%BB%AC%0D%0AKEEP%0D%0ACALM%0D%0AAND%0D%0A"..URL.escape(matches[1]).."&bc="..bgcolor.."&tc="..textcolor.."&cc="..text.."&w="..size.."&uc=true&ts=true&ff=PNG&ps=sq"
